...
public class VacheTest {
    ...
    public void testGetPrix() {
        Vache vache = new Vache(150.0f, LocalDate.of(2100, Month.NOVEMBER, 28), (short) 55.0,  1200,"vachetest",50.0f, new Etable(30,"Aquitaine"));
    ...
    public void testGetIsCommercialise(){
        Vache vache = new Vache(150.0f, LocalDate.of(2100,Month.DECEMBER,29), (short) 55.0,  1200,"vachetest",50.0f, new Etable(1245, "PACA"));
